...
{
  flash_filler = new OboutInc.Editor.FieldsFiller(Page,"flash-upload",Page.Request["localization_path"],Page.Request["language"]);
}
</script>
...
<form target="fraExecute" id="frmFile" action="myFlashUpload" style="margin: 0px;" enctype="multipart/form-data" method="post">
...
<tr>
<td style="width:1%; white-space:nowrap;">
<%= flash_filler.Get("description","Description") %>:
</td>
<td style="width:100%">
...
<input type="hidden" name="saved" value="<%= flash_filler.Get("saved","Flash saved successfully") %>" />
<input type="hidden" name="notsaved" value="<%= flash_filler.Get("not-saved","No Flash saved") %>" />
</form>
