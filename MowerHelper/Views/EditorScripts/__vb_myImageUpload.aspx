...
Protected image_filler As  OboutInc.Editor.FieldsFiller
...
<body style="overflow: hidden; margin: 0px; padding: 5px;" onload="onLoad()">
        ...
        <form target="fraExecute" id="frmFile" action="myImageUpload_vb.aspx" style="margin: 0px;" enctype="multipart/form-data" method="post">
